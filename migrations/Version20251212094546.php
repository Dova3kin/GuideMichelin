 ...
 */
final class Version20251212094546 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE plat (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE plat_resto (plat_id INT NOT NULL, resto_id INT NOT NULL, INDEX IDX_1929D3CDD73DB560 (plat_id), INDEX IDX_1929D3CD2978E8D1 (resto_id), PRIMARY KEY(plat_id, resto_id)) DEFAULT CHARACTER SET utf8mb4');
